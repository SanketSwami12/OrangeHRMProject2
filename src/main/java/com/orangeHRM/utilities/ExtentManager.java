...
public class ExtentManager {
	...
	public synchronized static ExtentReports getReprter() {
		if (extent == null) {
	...
	public synchronized static ExtentTest startTest(String testName) {
		ExtentTest extentTest = getReprter().createTest(testName);
		test.set(extentTest);
		return extentTest;
	...
	public static String getTestName() {
		...
		if (currentTest != null) {
			...
			return "No test is currenlty active for this thread";
		}
		return "No test is currenlty active for this thread";
...

	{
		//getTest().info(logMessage);
		   ExtentTest currentTest = getTest();
		    ...
		    if (currentTest == null) {
		        System.out.println("ERROR: ExtentTest is NULL for message: " + logMessage);
		        return;
		    }
